  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Last updated: April 10, 2026</p>

        <div className="mb-10 p-5 rounded-xl bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900 text-slate-700 dark:text-slate-300 text-sm">
          LandYourJob is an AI-powered SaaS platform. Users purchase subscriptions or credits to access resume tailoring and ATS scoring features. We do not guarantee employment, placement, or job interviews. We are not a recruitment agency.
        </div>
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <p className="mb-3 text-sm text-slate-600 dark:text-slate-400">LandYourJob provides a software-as-a-service (SaaS) platform. All charges are for platform access and AI compute usage.</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>Subscription charges are <strong>non-refundable</strong> except in cases of verified billing errors.</li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>Include the Cashfree payment ID or order ID from your billing page</li>
